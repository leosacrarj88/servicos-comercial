...
# ===============================
# HISTÓRICO DE ENDEREÇOS (SEM ARQUIVO / CLOUD-SAFE)
# - Mantém histórico apenas em memória (st.session_state)
# - No Streamlit Community Cloud não há escrita persistente em disco
# ===============================

def load_address_history(limit: int = 25) -> list[str]:
    hist = st.session_state.get("address_history", [])
